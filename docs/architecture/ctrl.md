...
The control and ingestion servers are separate Express applications. Metrics are accepted on port 3001, not through the control server. No authentication, authorization, rate limiting, or configurable port support is currently present.
